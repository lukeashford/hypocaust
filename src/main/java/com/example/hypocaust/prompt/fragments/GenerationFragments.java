...
/**
 * Prompt fragments for content generation operators.
 *
 * <p>These fragments provide specialized instructions for image prompt engineering,
 * title generation, and creative writing tasks. They are designed to be used with
 * smaller, faster models like Haiku for efficiency.
 */
public final class GenerationFragments {
  ...
  /**
   * Image prompt engineering instructions for transforming concepts into detailed
   * prompts optimized for AI image generation models.
   */
  ...
  /**
   * Title and metadata generation for images.
   * Extracts concise, descriptive titles and alt text from image prompts.
   */
  ...
  /**
   * Title generation for creative writing pieces.
   * Extracts engaging titles from content.
   */
