...
public final class PromptFragments {
  ...
  public static PromptFragment selfHealing() {
    return new PromptFragment(
        ...
        """
            After any action, evaluate the result. If the tool returned an error:
            - If it mentions timeout, network, or "All models failed": infrastructure is down.
              Do NOT retry the same tool. Report the issue and stop.
            - If it mentions missing parameters or invalid input: adjust your parameters and retry
