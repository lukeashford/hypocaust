...
/**
 * Records what changed in a TaskExecution.
 * Only present if there were artifact changes.
 *
...
public record TaskExecutionDelta(
  ...
  public static TaskExecutionDelta empty() {
    return new TaskExecutionDelta(List.of(), List.of(), List.of());
  }
}
