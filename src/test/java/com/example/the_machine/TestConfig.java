...
/**
 * Test configuration that provides mock implementations of beans
...
public class TestConfig {
    ...
    /**
     * Provides a mock implementation of the HelloWorldAgentService
    ...
    /**
     * Provides a mock implementation of the ChatLanguageModel
     * to avoid making real API calls during tests.
     */
    @Bean
    @Primary
